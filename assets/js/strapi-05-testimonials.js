...
const apiURLTestimonial = "https://www.geidyestrada.com/api/Testimonial";
    ...
    if (data && data.data) {
      ...
      picArray.forEach((pic, index) => {
        ...
        if (imageElement && pic?.url) {
          imageElement.src = `https://www.geidyestrada.com${pic.url}`;
...
async function loadTestimonialContent() {
  ...
  try {
    ...
    const response = await fetch(
      "https://www.geidyestrada.com/api/testimonial?populate=*"
    );
    if (!response.ok) {
      throw new Error(
...
async function updateTestimonialContent() {
  ...
  try {
    ...
    const response = await fetch("https://www.geidyestrada.com/api/testimonial", {
      method: "PUT",
      headers: {
